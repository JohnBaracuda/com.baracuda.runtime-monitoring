...
namespace Baracuda.Monitoring.Core.Systems
{
    ...
    internal class MonitoringProfiler : IMonitoringProfiler
    {
        ...
        {
            if (MonitoringSystems.MonitoringSettings.AsyncProfiling)
            {
        ...
        private void CreateInstanceMethodProfile(MethodInfo methodInfo, MonitorAttribute attribute)
        {
            try
            {
                ...
                // create a generic type definition.
                var genericType = typeof(MethodProfile<,>).MakeGenericType(methodInfo.DeclaringType, methodInfo.ReturnType.NotVoid(typeof(Void)));
        ...
        private void CreateStaticMethodProfile(MethodInfo methodInfo, MonitorAttribute attribute)
        {
            try
            {
                ...
                var genericType =
                    typeof(MethodProfile<,>).MakeGenericType(declaringType, methodInfo.ReturnType.NotVoid(typeof(Void)));
